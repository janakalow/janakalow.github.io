...
See [the Code documentation]({% link d/ui-components/code/index.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({% link d/navigation/main/external.md %}) for more details.
...
See [Customization]({% link d/customization.md %}) for more information.
...
See [Callouts]({% link d/ui-components/callouts.md %}) for more information.
